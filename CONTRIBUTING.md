...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/dentiny/duckdb-hedged-request/issues).
* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/dentiny/duckdb-hedged-request/issues/new/choose). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
/duckdb_build_dir # git clone https://github.com/dentiny/duckdb-hedged-request.git && cd duckdb-hedged-request
/duckdb_build_dir/duckdb-hedged-request # git submodule update --init --recursive
/duckdb_build_dir/duckdb-hedged-request # CMAKE_BUILD_PARALLEL_LEVEL=$(nproc) make
```
